...
public class CreationDateQueryFilterStringToMapConverter implements TypeConverters{
	
	public static Logger log = LogManager.getLogger(CreationDateQueryFilterStringToMapConverter.class);
    @Converter
    public Map<String, Object> toMap(String map) throws IOException {
    	
    	log.info("In CreationDateQueryFilterStringToMapConverter Converters"+map);
