...
import com.oracle.oep.order.abm.transform.ProcessNotifRemoveServiceAbmMapping;
...
public class ProcessNotifRemoveServiceProcessor {

	public static final Logger log = LogManager.getLogger(ProcessNotifRemoveServiceProcessor.class);
	 ...
	 * 
	 */
	public void processNotifRemoveService(final NotifRemoveServiceNotification request, final Exchange exchange,
		...
		ProcessNotifRemoveServiceAbmMapping mapping = new ProcessNotifRemoveServiceAbmMapping();
